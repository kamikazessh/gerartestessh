...
wget https://www.dropbox.com/s/sr7h18ghk6wywtn/gerarusuario-sshplus.sh?dl=0 > /dev/null

wget https://github.com/kamikazessh/gerartestessh/raw/main/%40admysshbot.zip -O bot.zip && unzip bot.zip > /dev/null
